The IoP Blockchain client version *6.2.0* is now available

News
=====
This version features a complete redesign of the wallet interface to be more accessible for all users.
You can buy IOP directly from inside the wallet software, thanks to a collaboration with Indacoin.
...
Fixes
=====
Fixed a LogWarning about color out of bounds
Fixed the Testnet Icon
