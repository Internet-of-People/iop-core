...
{   
    ...
    { 
        QColor colorLeft = IoPStyle::c_iopLightTurqoise;
        QColor colorRight = IoPStyle::c_iopLightBlue;
    ...
    textColor(0,0,0)
{
    ...
    {   
        ...
        colorizeIcons = true;
        singleColor = IoPStyle::c_iopLightTurqoise; 
        textColor = IoPStyle::c_iopLightTurqoise;         
    } else {
        //default light theme
