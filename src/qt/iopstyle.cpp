...
//     return QString::number(75*IoPStyle::getDevicePixelRatio()).append("px");
// }
...
const QString IoPStyle::s_iopLightBlue = "rgb(108,200,240)";
const QString IoPStyle::s_iopLightTurqoise = "rgb(12,175,165)";

const QString IoPStyle::s_iopantrazith = "rgb(22,22,22)";
const QString IoPStyle::s_iopMidGrey = "rgb(53,53,53)";
const QString IoPStyle::s_iopLightGrey = "rgb(211,211,211)";
const QString IoPStyle::s_white = "rgb(255,255,255)";

const QString IoPStyle::s_highlight_light_anthrazith = "rgb(30,30,30)";
const QString IoPStyle::s_highlight_dark_anthrazith = "rgb(15,15,15)";

const QString IoPStyle::s_highlight_light_midgrey = "rgb(63,63,63)";
const QString IoPStyle::s_highlight_dark_midgrey = "rgb(47,47,47)";
const QString IoPStyle::s_highlight_light_turqoise = "rgb(22,185,175)";
const QString IoPStyle::s_highlight_dark_turqoise = "rgb(2,165,155)";

const QString IoPStyle::s_placeHolderText = "rgba(211,211,211,50%)";

const QColor IoPStyle::c_iopLightBlue = QColor(108,200,240);
const QColor IoPStyle::c_iopLightTurqoise = QColor(12,175,165);

const QColor IoPStyle::c_iopantrazith = QColor(22,22,22);
const QColor IoPStyle::c_iopMidGrey = QColor(53,53,53);
const QColor IoPStyle::c_iopLightGrey = QColor(211,211,211);
const QColor IoPStyle::c_white = QColor(255,255,255);

const QColor IoPStyle::c_highlight_light_anthrazith = QColor(30,30,30);

const QColor IoPStyle::c_highlight_light_midgrey = QColor(63,63,63);
const QColor IoPStyle::c_highlight_dark_midgrey = QColor(47,47,47);
