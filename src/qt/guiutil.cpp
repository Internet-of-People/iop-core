...
bool openIoPConf()
{
    ...
    /* Open iop.conf with the associated application */
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if(fAutoStart && !foundItem) {
        ...
        LSSharedFileListInsertItemURL(loginItems, kLSSharedFileListItemBeforeFirst, nullptr, nullptr, iopAppUrl, nullptr, nullptr);
    }
...
QString getThemeStyleSheet(){
    ...
    QString backgroundColor, accentOne, accentTwo, buttonHover, fontColor;
    ...
    if(theme == "dark"){
     ...
     if(theme == "light"){
        accentOne = "rgb(204,204,204)";
        accentTwo = accentOne;
        buttonHover = "rgb(134,134,134)";
    ...
    return (
        ...
        "#lineb, #lineb1, #lineb2, #lineb3, #lineb4, #lineb5 { border-top: none; border-left: none; border-right: none; border-bottom: 1px; border-style: solid; border-color: " + sSecondaryGray + ";}"
        "#labelBalanceText, #labelPendingText, labelTotalText {color: " + sSecondaryLightGray + ";}"
